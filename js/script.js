...
const elementInsertBeforeForm = document.querySelector('.top-form__insert_Before')
...
const elementForm = document.querySelector('.top-header-form__container')
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo)  , 
      elementForm.innerHTML = `<form action="#" class="page__search search-page">
                
                <div class="search-page__select select">
                    <div class="search-page__title">
                      <span>All</span> <span data-text="Selected " class="search-page__quantity"></span>
                    </div>
                      ...
                      <div class="categories-search__row">
                        <div class="categories-search__column">
                          <ul class="categories-search__list">
                            <li>
                              <label for="" class="categories-search__checkbox checkbox">
                                <input type="checkbox" class="checkbox__input" data-error="Ошибка" value="">
                                <span class="checkbox__text"><span> For running </span></span>
                              </label>
                            </li>
                           <li> <label for="" class="categories-search__checkbox checkbox">
                                                           <input type="checkbox" class="checkbox__input" data-error="Ошибка" value="">
                                                           <span class="checkbox__text"><span> Sneakers </span></span>
                                                         </label></li>
                            
                             <li> <label for="" class="categories-search__checkbox checkbox">
                                                             <input type="checkbox" class="checkbox__input" data-error="Ошибка" value="">
                                                             <span class="checkbox__text"><span> For walking </span></span>
                                                           </label></li>
                            
                              <li><label for="" class="categories-search__checkbox checkbox">
                                                              <input type="checkbox" class="checkbox__input" data-error="Ошибка" value="">
                                                              <span class="checkbox__text"><span> For sport </span></span>
                                                            </label></li>
                ...
                <button type="submit" class="search-page__btn btn"> </button>
              </form> ` , elementSearch.innerHTML = `` , headerContent.append(elementContact)  , elementContact.classList.add('top-header__columns') )   
      : 
      functionehead( headerContent.prepend(elementLogo) , 
        elementSearch.innerHTML = `<form action="#" class="page__search search-page">
                ...
                <button type="submit" class="search-page__btn btn"> </button>
              </form> ` , elementForm.innerHTML = `` ,  elementToheaderColumnsMenus.append(elementContact) ,  elementContact.classList.remove('top-header__columns')  )
 
      function functionehead(sids , long , label , menu , l , joins) {
  return sids ;
  return  long ; 
  return label ;
  return  menu ; 
